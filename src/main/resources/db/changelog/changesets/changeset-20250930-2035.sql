...
-- changeset orhangazibarak:1759264508408-1 splitStatements:false
...
-- changeset orhangazibarak:1759264508408-2 splitStatements:false
ALTER TABLE users ADD CONSTRAINT "usersPK" PRIMARY KEY (id);

-- changeset orhangazibarak:1759264508408-3 splitStatements:false
ALTER TABLE users DROP CONSTRAINT UC_USERSEMAIL_COL;

-- changeset orhangazibarak:1759264508408-4 splitStatements:false
